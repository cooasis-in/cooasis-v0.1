        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[calc(100vh-100px)] items-center">
          ...
          <div className="col-span-6 lg:pl-14">
            <div className="bg-white rounded-[25px] border-[1px] border-[#014F5921] py-8 px-8 xl:px-[10%]">
              <h2 className="text-[50px] font-normal text-[#014F59] text-center">
                Sign up
              </h2>
              <form>
              ...
              <Link
                to="/verify"
                className="text-[24px] text-[#E1FF26] leading-[19.94px] font-normal bg-[#014F59] px-8 py-6 w-full rounded-full flex items-center justify-center"
              >
                <span className="mr-2">
                  <img
