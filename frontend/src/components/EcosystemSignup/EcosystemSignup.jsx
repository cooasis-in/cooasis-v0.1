        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 min-h-[calc(100vh-100px)] items-center'>
          <div className={`col-span-6 lg:block ${showOnClic ? 'hidden': ''}`}>
            <div className="!relative md:mt-[5%] lg:mt-[10%]">
              <h1 className="media text-[60px] sm:text-[80px] lg:text-[60px] text-[#014F59] leading-[60px] sm:leading-[70px] lg:leading-[50px] font-normal xl:max-w-[686px] text-center lg:text-left mt-16 ">Nex-gen design
                ecosystem</h1>
          ...
          <div className={`col-span-6 lg:pl-14 lg:block ${ showOnClic ? '': 'hidden'}`}>
            <div className="res-adjust bg-white rounded-[40px] lg:rounded-[25px] mt-10 lg:mt-0 border-[1px] border-[#014F5921] p-4 sm:p-8 xl:px-[10%] max-w-[355px] sm:max-w-[455px] md:max-w-[555px] lg:max-w-auto mx-auto">
              <h2 className="text-[35px] lg:text-[50px] leading-[29.08px] font-normal text-[#014F59] text-center mt-2 lg:mt-0">Sign up</h2>
              <form>
                <div className="mb-3 mt-8 lg:mt-6 xl:mt-[5%] flex items-center relative">
                  <input
                    ...
                    className="text-[12px] lg:text-[17px] text-[#014F5980] leading-[9.97px] font-extralight w-full px-6 py-4 lg:px-8 lg:py-6 border-[1px] border-[#014F5917] rounded-full focus:outline-none focus:ring-2"
                  />
              ...
              <Link to="/verify" className="text-[16px] lg:text-[24px] text-[#E1FF26] leading-[14.13px] lg:leading-[19.94px] font-normal bg-[#014F59] px-6 py-4 lg:px-8 lg:py-6 w-full rounded-full flex items-center justify-center">
                <span className="mr-2">
           ...
           <p className="mt-6 text-[14px] text-[#014F59] leading-[20.52px] fomt-normal text-center">
            ...
            <p className="mt-5 text-[12px] text-[#014F59] leading-[17.59px] fomt-normal text-center">
                By creating an account you agree with our <span><u>Terms of Service, Privacy Policy,</u> </span>
                and our default <span><u>Notification Settings</u>.</span>
              </p>
              <p className="mt-3 text-[12px] text-[#014F59] leading-[17.59px] fomt-normal text-center">
                Already have an account? <span className="text-[#7D22FF]"><u>Sign In</u></span>
              </p>
