  ...
  return ( 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div className="border rounded-[40px] p-4 py-6 col-span-full sm:col-span-2 md:col-span-3 lg:col-span-4">
          <h1 className="f-PowerGrotesk text-center text-[#014F59] mb-6 leading-[20px] text-[20px] mt-8">
            Invite a friend and get <br /> INR 500
          </h1>
          <p className="f-HelveticaNeueLight text-center text-[#014F599C]">
          ...
          <div className="flex flex-row sm:flex-row justify-center items-center mt-8 gap-4">
            ...
            {/* Button 2 */}
            <button className="f-PowerGrotesk text-base text-[#E1FF26] bg-[#014F59] px-8 py-4 sm:py-6 rounded-full flex items-center justify-center w-full sm:w-auto  font-normal h-[70px]">
              Invite friend
            </button>
          </div>
        </div>
        ...
        <div className="relative md:col-span-3 bg-[#FF8E8E4D] text-center rounded-[35px] p-6 mt-4">
          ...
          <p className="f-HelveticaNeueLight relative text-[#FF8E8E] mt-4 z-10 text-[12px]">
